...
/*   Updated: 2018/04/18 18:39:24 by vgauther         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void check_define(void)
{
  ...
  if (SIZE_X != 1000 || SIZE_Y != 600)
    ft_putstr("\nVous avez choisis de modifier les parametres de bases. Il se peut que des erreurs visuel et systeme apparaissent.\n");
}
